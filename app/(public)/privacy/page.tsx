      ...
      <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-sm p-8">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 mb-4">
            ...
            information when you use our web service (the &quot;Service&quot;).
          </p>
        ...
        <section className="mb-8">
          ...
          <h3 className="text-lg font-medium text-gray-800 mb-2">2.4 Usage Information</h3>
          <p className="text-gray-700 mb-4">
            We may collect usage information including:
          </p>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside text-gray-700 space-y-1">
            ...
            <li>Display events, schedules, and announcements</li>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside text-gray-700 space-y-1">
            ...
            <li><strong>Service Providers:</strong> We use trusted third-party services (cloud hosting providers)</li>
